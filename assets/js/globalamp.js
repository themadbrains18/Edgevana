...
function introAnimate() {
  ...
  if (animations.dots.current <= animations.dots.total) {
    ...
    if(window.innerWidth>500){
        document.querySelector('.svg-wrapper').classList.remove('svg-wrapper-width-mob');
        document.querySelector('.svg-wrapper').classList.add('svg-wrapper-width-desk');
        
    }
    else{
        document.querySelector('.svg-wrapper').classList.remove('svg-wrapper-width-desk');
        document.querySelector('.svg-wrapper').classList.add('svg-wrapper-width-mob');
